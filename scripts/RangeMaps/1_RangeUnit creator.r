...
for(i in 1:length(sgcnlist)){
  ...
  sws_HUC8_1a <- sws_HUC8_1a[c("NAME","TaxaDisplay","SCOMNAME","SNAME","PrimMacro","b","m","w","y","Occurrence","GRANK","SRANK","USESA","SPROT","PBSSTATUS","geometry")]
...
for(i in 1:length(sgcnlist)){
  ...
  sws_county_1a <- sws_county_1a[c("COUNTY_NAM","TaxaDisplay","SCOMNAME","SNAME","PrimMacro","b","m","w","y","Occurrence","GRANK","SRANK","USESA","SPROT","PBSSTATUS","geometry")] # 
...
HUC8agg_all <- HUC8agg_all[c("NAME","TaxaDisplay","SCOMNAME","SNAME","PrimMacro","b","m","w","y","Occurrence","GRANK","SRANK","USESA","SPROT","PBSSTATUS")]
...
countyagg <- countyagg[c("COUNTY_NAM","TaxaDisplay","SCOMNAME","SNAME","PrimMacro","b","m","w","y","Occurrence","GRANK","SRANK","USESA","SPROT","PBSSTATUS")]
